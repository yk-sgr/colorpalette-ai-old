        ...
        <div className={"group flex flex-col gap-2"}>
          ...
          <div
            ...
            <PlusCircle strokeWidth={1} size={48}
                        className={"text-muted-foreground/40 transition duration-100 ease-out group-hover:text-muted-foreground/70 group-hover:transition group-hover:duration-75 group-hover:ease-in group-active:text-muted-foreground group-active:duration-0 group-active:border-foreground/80"}/>
          </div>
          <p
