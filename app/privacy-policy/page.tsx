  ...
  return (
    <div className={"container mx-auto"}>
      ...
      <p>
        ...
        Terms of Service. This Privacy Policy was created with{" "}
      ...
      <ul>
        ...
        <li>
          ...
          refers to , that is responsible for your information under this
          Privacy Policy.
        </li>
        <li>
        ...
        <li>
          ...
          signs up to use the Service to manage the relationships with your
        ...
        <li>
          Personnel:&nbsp;refers to those individuals who are employed by or are
      ...
      <p>
        ...
        when you visit our&nbsp;platform. This information may be used to
        connect your computer to the Internet. Other information collected
        ...
        (we sometimes aggregate with similar information from other Users), the
        full Uniform Resource Locator (URL) clickstream to, through and from our
      ...
      <p>
        ...
        navigate the&nbsp;platform. This information does not reveal your
        ...
        of our&nbsp;platform, and for our internal analytics and reporting
        purposes.
      </p>
      ...
      <p>
        ...
        the assets of or any of its Corporate Affiliates (as defined herein), or
        that portion of or any of its Corporate Affiliates to which the Service
        relates, or in the event that we discontinue our business or file a
      ...
      <p>
        ...
        control with , whether by ownership or otherwise. Any information
      ...
      <p>
        ...
        Agreement and your use of the . Your use of the may also be subject to
        other local, state, national, or international laws.
      </p>
      <p>
        By using or contacting us directly, you signify your acceptance of this
      ...
      <p>
        ...
        how it&apos;s being used. By using our , registering an account, or
