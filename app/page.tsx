...
function Pricing() {
  ...
  return (
    <section className="container mt-20 grid gap-6 pb-8 pt-6 md:py-10">
      ...
      <div className="w-full justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:w-2/3">
        {
          plans.map((item, idx) => (
            <div key={idx} className={"mt-6 flex flex-1 flex-col items-stretch rounded-xl border-2 sm:mt-0"}>
