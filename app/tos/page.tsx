  ...
  return (
    <div className={"container mx-auto"}>
      ...
      <p>
        ...
        revise the resources usage policy in any moment. This Terms &amp;
      ...
      <p>
        ...
        to download, install and use the strictly in accordance with the terms
        of this Agreement.
      </p>
      <p>
        These Terms &amp; Conditions are a contract between you and (referred to
        in these Terms &amp; Conditions as &quot;&quot;, &quot;us&quot;,
        &quot;we&quot; or &quot;our&quot;), the provider of the website and the
        services accessible from the website (which are collectively referred to
        in these Terms &amp; Conditions as the &quot; Service&quot;).
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          refers to , that is responsible for your information under this Terms
          &amp; Conditions.
        </li>
        <li>
          Country: where or the owners/founders of are based, in this case is
        </li>
        <li>
        ...
        <li>
          Service: refers to the service provided by as described in the
      ...
      <ul>
        <li>
          ...
          outsource, disclose or otherwise commercially exploit the or make the
        ...
        <li>
          ...
          or the licensors of the .
        </li>
      </ul>
      <h1 className="mb-1 mt-2 text-xl font-bold">Return and Refund Policy</h1>
      <p>
        Thanks for shopping at . We appreciate the fact that you like to buy the
        stuff we build. We also want to make sure you have a rewarding
      ...
      <p>
        ...
        apply to transactions at . We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at , you agree to the terms along with &apos;s&nbsp;Privacy
        Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, &quot;Suggestions&quot;) provided by you to with respect
        to the shall remain the sole and exclusive property of .
      </p>
      <p>
        {" "}
      ...
      <p>
        ...
        with complete transparency into what is being set when you visit our
        site and how it&apos;s being used. By using our , registering an
      ...
      <p>
        ...
        may contain links to other websites not operated or controlled by . We
      ...
      <p>
        {" "}
        uses &quot;Cookies&quot; to identify the areas of our website that you
        ...
        performance and functionality of our but are non-essential to their use.
        ...
        every time you visit the as we would not be able to remember that you
        had logged in previously. Most web browsers can be set to disable the
      ...
      <p>
        ...
        users generally at ’s sole discretion, without prior notice to you. You
      ...
      <p>
        ...
        permanently, the or any service to which it connects, with or without
      ...
      <p>
        {" "}
        may from time to time provide enhancements or improvements to the
        features/ functionality of the , which may include patches, bug fixes,
        updates, upgrades and other modifications (&quot;Updates&quot;).
      </p>
      <p>
        Updates may modify or delete certain features and/or functionalities of
        the . You agree that has no obligation to (i) provide any Updates, or
      ...
      <p>
        ...
        integral part of the , and (ii) subject to the terms and conditions of
        this Agreement.
      </p>
      ...
      <p>
        ...
        or any other aspect thereof. does not assume and shall not have any
      ...
      <p>
        ...
        Agreement. You may also terminate this Agreement by deleting the and all
        copies thereof from your computer.
      </p>
      <p>
        Upon termination of this Agreement, you shall cease all use of the and
        delete all copies of the from your computer.
      </p>
      <p>
      ...
      <p>
        ...
        material on our constitutes an infringement on your copyright, please
      ...
      <p>
        ...
        fees, due to or arising out of your: (a) use of the ; (b) violation of
      ...
      <p>
        The is provided to you &quot;AS IS&quot; and &quot;AS AVAILABLE&quot;
        and with all faults and defects without warranty of any kind. To the
        maximum extent permitted under applicable law, , on its own behalf and
        ...
        implied, statutory or otherwise, with respect to the , including all
        ...
        limitation to the foregoing, provides no warranty or undertaking, and
        makes no representation of any kind that the will meet your
      ...
      <p>
        Without limiting the foregoing, neither nor any &apos;s provider makes
        any representation or warranty of any kind, express or implied: (i) as
        to the operation or availability of the , or the information, content,
        and materials or products included thereon; (ii) that the will be
        uninterrupted or error-free; (iii) as to the accuracy, reliability, or
        currency of any information or content provided through the ; or (iv)
        that the , its servers, the content, or e-mails sent from or on behalf
        of are free of viruses, scripts, trojan horses, worms, malware,
      ...
      <p>
        ...
        of and any of its suppliers under any provision of this Agreement and
        your exclusive remedy for all of the foregoing shall be limited to the
        amount actually paid by you for the .
      </p>
      <p>
        To the maximum extent permitted by applicable law, in no event shall or
        ...
        interruption, for personal injury, for loss of privacy arising out of or
        in any way related to the use of or inability to use the , third-party
        software and/or third-party hardware used with the , or otherwise in
        connection with any provision of this Agreement), even if or any
      ...
      <p>
        ...
        notices published by on the Services, shall constitute the entire
        agreement between you and concerning the Services. If any provision of
        ...
        further or continuing waiver of such term or any other term, and &apos;s
        failure to assert any right or provision under this Agreement shall not
        constitute a waiver of such right or provision. YOU AND AGREE THAT ANY
      ...
      <p>
        By continuing to access or use our after any revisions become effective,
        you agree to be bound by the revised terms. If you do not agree to the
        new terms, you are no longer authorized to use .
      </p>

      <h1 className="mb-1 mt-2 text-xl font-bold">Entire Agreement</h1>
      <p>
        The Agreement constitutes the entire agreement between you and regarding
        your use of the and supersedes all prior and contemporaneous written or
        oral agreements between you and .
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other &apos;s services, which will provide to you at
      ...
      <p>
        The and its entire contents, features and functionality (including but
        ...
        by , its licensors or other providers of such material and are protected
        by and international copyright, trademark, patent, trade secret and
        other intellectual property or proprietary rights laws. The material may
        ...
        of , unless and except as is expressly provided in these Terms &amp;
      ...
      <p>
        ...
        between you and concerning the Services or this agreement, whether in
      ...
      <p>
        In the event of a dispute, you or must give the other a Notice of
        ...
        Dispute via email to:&nbsp;. will send any Notice of Dispute to you by
        mail to your address if we have it, or otherwise to your email address.
        You and will attempt to resolve any dispute through informal negotiation
        within sixty (60) days from the date the Notice of Dispute is sent.
        After sixty (60) days, you or may commence arbitration.
      </p>

      <h1 className="mb-1 mt-2 text-xl font-bold">Binding Arbitration</h1>
      <p>
        If you and don’t resolve any dispute by informal negotiation, any other
      ...
      <p>
        ...
        and will become the sole property of without any compensation or credit
        to you whatsoever. and its affiliates shall have no obligations with
      ...
      <p>
        {" "}
        may, from time to time, include contests, promotions, sweepstakes, or
      ...
      <p>
        ...
        representative of . will be entitled to injunctive or other equitable
        relief (without the obligations of posting any bond or surety) in the
        event of any breach or anticipatory breach by you. operates and controls
        the Service from its offices in . The Service is not intended for
        distribution to or use by any person or entity in any jurisdiction or
        country where such distribution or use would be contrary to law or
        regulation. Accordingly, those persons who choose to access the Service
        ...
        incorporate the Privacy Policy) contains the entire understanding, and
        supersedes all prior understandings, between you and concerning its
      ...
      <p>
        In no event shall be liable for any special, direct, indirect,
      ...
      <p>
        The Service and its contents are provided &quot;as is&quot; and &quot;as
        available&quot; without any warranty or representations of any kind,
        whether express or implied. is a distributor and not a publisher of the
        content supplied by third parties; as such, exercises no editorial
        ...
        service or merchandise provided through or accessible via the Service.
        Without limiting the foregoing, specifically disclaims all warranties
        and representations in any content transmitted on or in connection with
        the Service or on sites that may appear as links on the Service, or in
        ...
        rights. No oral advice or written information given by or any of its
        ...
        change without notice. Without limiting the foregoing, does not warrant
        that the Service will be uninterrupted, uncorrupted, timely, or
        error-free.
      </p>
